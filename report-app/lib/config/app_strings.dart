...
class AppStrings {
  ...
  // Login mobile — identitas Business Project (bukan admin panel).
  static const loginTitle = 'Backpacker';
  static const loginTagline = 'Marketplace Jasa On-Demand';
  static const loginDescription =
      'Masuk untuk membuat tugas, mengambil pekerjaan, dan mengelola pesanan Anda.';
  ...
  static const registerDescription =
      'Buat akun untuk menjadi pembuat tugas sekaligus pelaksana jasa.';
  ...
  static const checkinDone = 'Sudah check-in hari ini';
