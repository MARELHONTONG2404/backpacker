  ...
  <div class="tree-sidebar" :class="{ collapsed: collapsed, resizing: isResizing, 'no-initial-transition': isLoadingFromStorage}" :style="{ width: sidebarWidth + 'px' }">
    ...
    <div class="tree-header">
      ...
      <div class="tree-actions" v-show="!collapsed">
        ...
        <el-tooltip :content="t('components.treePanel.refresh')" placement="right">
    ...
    <div class="tree-search" v-show="!collapsed" v-if="showSearch">
      <el-input v-model="searchKeyword" :placeholder="displayPlaceholder" clearable>
        <template #prefix>
...
const displayTitle = computed(() => props.title || t('components.treePanel.defaultTitle'))
const displayPlaceholder = computed(() => props.searchPlaceholder || t('components.treePanel.searchPlaceholder'))
