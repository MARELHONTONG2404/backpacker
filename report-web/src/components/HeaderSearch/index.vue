  ...
  <div class="header-search">
    ...
    >
      <el-input
        ...
        @input="querySearch"
        prefix-icon="Search"
        :placeholder="t('components.headerSearch.placeholder')"
        clearable
      ...
      <div class="result-count" v-if="search && options.length > 0">
        {{ t('components.headerSearch.resultCount', { count: options.length }) }}
      </div>
      ...
      <div class="result-wrap">
        <el-scrollbar>
          ...
          <div class="empty-state" v-else-if="search && options.length === 0">
            ...
            <p class="empty-text">{{ t('components.headerSearch.notFound', { keyword: search }) }}</p>
            <p class="empty-tip">{{ t('components.headerSearch.tryOther') }}</p>
          </div>
      ...
      <div class="search-footer">
        <span class="shortcut-item">
          <kbd>↑</kbd><kbd>↓</kbd> {{ t('components.headerSearch.navigate') }}
        </span>
        <span class="shortcut-item">
          <kbd>↵</kbd> {{ t('components.headerSearch.select') }}
        </span>
        <span class="shortcut-item">
          <kbd>Esc</kbd> {{ t('components.headerSearch.close') }}
        </span>
      </div>
    </el-dialog>
  </div>
