    ...
    <el-form>
        <el-form-item>
            <el-radio v-model='radioValue' :value="1">
                {{ t('crontab.wildcard', { unit: t('crontab.unit.minute'), chars: '[, - * /]' }) }}
            </el-radio>
        </el-form-item>
        ...
        <el-form-item>
            <el-radio v-model='radioValue' :value="2">
                ...
                <el-input-number v-model='cycle02' :min="cycle01 + 1" :max="59" /> {{ t('crontab.unit.minute') }}
            </el-radio>
        </el-form-item>
        ...
        <el-form-item>
            <el-radio v-model='radioValue' :value="3">
                {{ t('crontab.from') }}
                <el-input-number v-model='average01' :min="0" :max="58" /> {{ t('crontab.fromUnitStart', { unit: t('crontab.unit.minute') }) }}
