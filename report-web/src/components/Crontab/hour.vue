    ...
    <el-form>
        <el-form-item>
            <el-radio v-model='radioValue' :value="1">
                {{ t('crontab.wildcard', { unit: t('crontab.unit.hour'), chars: '[, - * /]' }) }}
            </el-radio>
        </el-form-item>
        ...
        <el-form-item>
            <el-radio v-model='radioValue' :value="2">
                ...
                <el-input-number v-model='cycle02' :min="cycle01 + 1" :max="23" /> {{ t('crontab.unit.hour') }}
            </el-radio>
        </el-form-item>
        ...
        <el-form-item>
            <el-radio v-model='radioValue' :value="3">
                {{ t('crontab.from') }}
                <el-input-number v-model='average01' :min="0" :max="22" /> {{ t('crontab.fromUnitStart', { unit: t('crontab.unit.hour') }) }}
                <el-input-number v-model='average02' :min="1" :max="23 - average01" /> {{ t('crontab.executeOnce') }}
            </el-radio>
        </el-form-item>
