    ...
    <el-form>
        <el-form-item>
            <el-radio v-model='radioValue' :value="1">
                {{ t('crontab.wildcard', { unit: t('crontab.unit.day'), chars: '[, - * ? / L W]' }) }}
            </el-radio>
        </el-form-item>

        <el-form-item>
            <el-radio v-model='radioValue' :value="2">
                {{ t('crontab.notSpecify') }}
            </el-radio>
        </el-form-item>
        ...
        <el-form-item>
            <el-radio v-model='radioValue' :value="3">
                ...
                <el-input-number v-model='cycle02' :min="cycle01 + 1" :max="31" /> {{ t('crontab.unit.day') }}
            </el-radio>
        </el-form-item>
        ...
        <el-form-item>
            <el-radio v-model='radioValue' :value="4">
                {{ t('crontab.from') }}
                <el-input-number v-model='average01' :min="1" :max="30" /> {{ t('crontab.onDate') }}, {{ t('crontab.fromUnitStart', { unit: t('crontab.unit.day') }) }}
                <el-input-number v-model='average02' :min="1" :max="31 - average01" /> {{ t('crontab.executeOnce') }}
            </el-radio>
        </el-form-item>

        <el-form-item>
            <el-radio v-model='radioValue' :value="5">
                {{ t('crontab.everyMonthOn') }}
