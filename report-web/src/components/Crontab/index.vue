<template>
    <div>
        <el-tabs type="border-card">
            <el-tab-pane :label="t('crontab.tab.second')" v-if="shouldHide('second')">
                <CrontabSecond
            ...
            <el-tab-pane :label="t('crontab.tab.minute')" v-if="shouldHide('min')">
                <CrontabMin
                    @update="updateCrontabValue"
                    :check="checkNumber"
                    :cron="crontabValueObj"
            ...
            <el-tab-pane :label="t('crontab.tab.hour')" v-if="shouldHide('hour')">
                <CrontabHour
                    @update="updateCrontabValue"
                    :check="checkNumber"
                    :cron="crontabValueObj"
            ...
            <el-tab-pane :label="t('crontab.tab.day')" v-if="shouldHide('day')">
                <CrontabDay
                    @update="updateCrontabValue"
                    :check="checkNumber"
                    :cron="crontabValueObj"
            ...
            <el-tab-pane :label="t('crontab.tab.month')" v-if="shouldHide('month')">
                <CrontabMonth
                    @update="updateCrontabValue"
                    :check="checkNumber"
                    :cron="crontabValueObj"
            ...
            <el-tab-pane :label="t('crontab.tab.week')" v-if="shouldHide('week')">
                <CrontabWeek
                    @update="updateCrontabValue"
                    :check="checkNumber"
                    :cron="crontabValueObj"
            ...
            <el-tab-pane :label="t('crontab.tab.year')" v-if="shouldHide('year')">
                <CrontabYear
                    @update="updateCrontabValue"
                    :check="checkNumber"
                    :cron="crontabValueObj"
        ...
        <div class="popup-main">
            <div class="popup-result">
                <p class="title">{{ t('crontab.expressionTitle') }}</p>
                <table>
                    <thead>
                        <tr>
            ...
            <div class="pop_btn">
                <el-button type="primary" @click="submitFill">{{ t('components.modal.confirm') }}</el-button>
                <el-button type="warning" @click="clearCron">{{ t('crontab.reset') }}</el-button>
                <el-button @click="hidePopup">{{ t('components.modal.cancel') }}</el-button>
            </div>
        </div>
    </div>
</template>
...
const tabTitles = computed(() => [
    t('crontab.tab.second'),
    t('crontab.tab.minute'),
    t('crontab.tab.hour'),
    t('crontab.tab.day'),
    t('crontab.tab.month'),
    t('crontab.tab.week'),
