<template>
   <div class="app-container">
      ...
      <el-table v-loading="loading" :data="roleList" @selection-change="handleSelectionChange">
         ...
         <el-table-column :label="t('system.createTime')" align="center" prop="createTime">
            <template #default="scope">
         ...
         <el-table-column :label="t('common.action')" align="center" class-name="small-padding fixed-width">
            <template #default="scope">
              ...
              <el-tooltip :content="t('system.role.dataPermission')" placement="top" v-if="scope.row.roleId !== 1">
                <el-button link type="primary" icon="CircleCheck" @click="handleDataScope(scope.row)" v-hasPermi="['system:role:edit']"></el-button>
              </el-tooltip>
              <el-tooltip :content="t('system.role.assignUser')" placement="top" v-if="scope.row.roleId !== 1">
      ...
      <el-dialog :title="title" v-model="open" width="500px" append-to-body>
         <el-form ref="roleRef" :model="form" :rules="rules" label-width="100px">
            ...
            <el-form-item prop="roleKey">
               <template #label>
                  <span>
                     <el-tooltip :content="t('system.role.roleKeyTip')" placement="top">
            ...
            <el-form-item :label="t('system.role.menuPermission')">
               <el-checkbox v-model="menuExpand" @change="handleCheckedTreeExpand($event, 'menu')">{{ t('system.tree.expandCollapse') }}</el-checkbox>
               <el-checkbox v-model="menuNodeAll" @change="handleCheckedTreeNodeAll($event, 'menu')">{{ t('system.tree.checkAll') }}</el-checkbox>
               <el-checkbox v-model="form.menuCheckStrictly" @change="handleCheckedTreeConnect($event, 'menu')">{{ t('system.tree.parentChildLink') }}</el-checkbox>
               <el-tree
                  class="tree-border"
                  :data="menuOptions"
                  show-checkbox
                  ...
                  :empty-text="t('system.tree.loading')"
      ...
      <el-dialog :title="title" v-model="openDataScope" width="500px" append-to-body>
         <el-form :model="form" label-width="100px">
            ...
            <el-form-item :label="t('system.role.dataPermission')" v-show="form.dataScope == 2">
               <el-checkbox v-model="deptExpand" @change="handleCheckedTreeExpand($event, 'dept')">{{ t('system.tree.expandCollapse') }}</el-checkbox>
               <el-checkbox v-model="deptNodeAll" @change="handleCheckedTreeNodeAll($event, 'dept')">{{ t('system.tree.checkAll') }}</el-checkbox>
               <el-checkbox v-model="form.deptCheckStrictly" @change="handleCheckedTreeConnect($event, 'dept')">{{ t('system.tree.parentChildLink') }}</el-checkbox>
               <el-tree
                  class="tree-border"
                  :data="deptOptions"
                  show-checkbox
...
const dataScopeOptions = computed(() => [
  { value: "1", label: t('system.role.dataScopeAll') },
  { value: "2", label: t('system.role.dataScopeCustom') },
  { value: "3", label: t('system.role.dataScopeDept') },
  { value: "4", label: t('system.role.dataScopeDeptBelow') },
  { value: "5", label: t('system.role.dataScopeSelf') }
])
...
const rules = computed(() => ({
  ...
  roleSort: [{ required: true, message: t('system.role.roleSortRequired'), trigger: "blur" }]
}))
...
function handleDelete(row) {
  ...
  proxy.$modal.confirm(t('system.role.confirmDelete', { id: roleIds })).then(function () {
...
function handleStatusChange(row) {
  ...
  proxy.$modal.confirm(t('system.role.confirmStatus', { action, name: row.roleName })).then(function () {
...
function handleAdd() {
  ...
  getMenuTreeselect()
  open.value = true
  title.value = t('system.role.addTitle')
}
...
function handleUpdate(row) {
  ...
  title.value = t('system.role.editTitle')
}
...
function handleDataScope(row) {
  ...
  title.value = t('system.role.assignDataScope')
}
