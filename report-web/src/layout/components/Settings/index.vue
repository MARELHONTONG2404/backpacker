<template>
  <el-drawer v-model="showSettings" :withHeader="false" :lock-scroll="false" direction="rtl" size="300px">
    <div class="setting-drawer-title">
      <h3 class="drawer-title">{{ t('layout.settings.navMenu') }}</h3>
    </div>
    <div class="nav-wrap">
    ...
    <div class="setting-drawer-title">
      <h3 class="drawer-title">{{ t('layout.settings.themeStyle') }}</h3>
    </div>
    ...
    <h3 class="drawer-title">{{ t('layout.settings.layoutConfig') }}</h3>
    ...
    <div class="drawer-item">
      <span>{{ t('layout.settings.showTagIcon') }}</span>
      <span class="comp-style">
    ...
    <div class="drawer-item">
      <span>{{ t('layout.settings.tagStyle') }}</span>
      <span class="comp-style">
        <el-radio-group v-model="settingsStore.tagsViewStyle" :disabled="!settingsStore.tagsView" size="small">
          <el-radio-button label="card">{{ t('layout.settings.tagStyleCard') }}</el-radio-button>
          <el-radio-button label="chrome">{{ t('layout.settings.tagStyleChrome') }}</el-radio-button>
        </el-radio-group>
      </span>
    </div>
    ...
    <el-button type="primary" plain icon="DocumentAdd" @click="saveSetting">{{ t('layout.settings.saveSettings') }}</el-button>
    <el-button plain icon="Refresh" @click="resetSetting">{{ t('layout.settings.resetSettings') }}</el-button>
  </el-drawer>
...
function saveSetting() {
  proxy.$modal.loading(t('layout.settings.savingSettings'))
...
function resetSetting() {
  proxy.$cache.local.remove('tags-view-visited')
  proxy.$modal.loading(t('layout.settings.clearingSettings'))
