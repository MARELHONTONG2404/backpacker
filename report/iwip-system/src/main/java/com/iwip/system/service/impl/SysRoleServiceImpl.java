...
import com.iwip.system.domain.SysRoleDept;
import com.iwip.system.domain.SysRoleMenu;
import com.iwip.system.domain.SysUserRole;
import com.iwip.system.mapper.SysRoleDeptMapper;
...
public class SysRoleServiceImpl implements ISysRoleService
{
    ...
    public void checkRoleAllowed(SysRole role)
    {
        ...
        {
            throw new ServiceException(MessageUtils.message("role.superadmin.forbidden"));
        }
    }
    ...
    public void checkRoleDataScope(Long... roleIds)
    {
        if (!SecurityUtils.isAdmin())
        {
            for (Long roleId : roleIds)
            {
                ...
                {
                    throw new ServiceException(MessageUtils.message("role.no.access"));
                }
            }
        }
    }
